...
import { useGetReceiverQuery, useWithdrawMoneyMutation } from "@/redux/features/Wallet/wallet.api";
...
const [withdrawMoney, { isLoading }] = useWithdrawMoneyMutation( );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      to: selectedUser.email || selectedUser.phone,
      amount,
    };
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      toast.error(err?.data?.message || "Withdraw money failed");
    }
  };

  return (
    <div className="relative max-w-md mx-auto space-y-3">
    <h1 className="text-center text-2xl  font-bold">Withdraw Money</h1>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        >
          ...
          {isLoading ? "Sending..." : "Withdraw Money"}
        </Button>
      </form>
